...
var __INIT__ = (function () {
  ...
  return function (__INIT__) {
    ...
    function relocateExports(exports, memoryBase, moduleLocal) {
      var relocated = {};
    ...
    function asmjsMangle(x) {
      ...
      return x.indexOf("dynCall_") == 0 || unmangledSymbols.indexOf(x) != -1
        ? x
        : "_" + x;
    }
    function loadWebAssemblyModule(binary, flags) {
      ...
      function loadModule() {
        ...
        var memoryBase = alignMemory(
          getMemory(memorySize + memoryAlign),
          memoryAlign
        );
      ...
      if (flags.loadAsync) {
        return Promise.all(
          neededDynlibs.map(function (dynNeeded) {
    ...
    var _TA_CDLCLOSINGMARUBOZU = (Module[
      "_TA_CDLCLOSINGMARUBOZU"
    ] = function () {
      return (_TA_CDLCLOSINGMARUBOZU = Module["_TA_CDLCLOSINGMARUBOZU"] =
        Module["asm"]["TA_CDLCLOSINGMARUBOZU"]).apply(null, arguments);
    });
    var _TA_CDLCONCEALBABYSWALL = (Module[
      "_TA_CDLCONCEALBABYSWALL"
    ] = function () {
    ...
    var _TA_CDLEVENINGDOJISTAR = (Module[
      "_TA_CDLEVENINGDOJISTAR"
    ] = function () {
    ...
    var _TA_CDLGAPSIDESIDEWHITE = (Module[
      "_TA_CDLGAPSIDESIDEWHITE"
    ] = function () {
    ...
    var _TA_CDLIDENTICAL3CROWS = (Module[
      "_TA_CDLIDENTICAL3CROWS"
    ] = function () {
    ...
    var _TA_CDLKICKINGBYLENGTH = (Module[
      "_TA_CDLKICKINGBYLENGTH"
    ] = function () {
    ...
    var _TA_CDLMORNINGDOJISTAR = (Module[
      "_TA_CDLMORNINGDOJISTAR"
    ] = function () {
    ...
    var _TA_CDLUPSIDEGAP2CROWS = (Module[
      "_TA_CDLUPSIDEGAP2CROWS"
    ] = function () {
      return (_TA_CDLUPSIDEGAP2CROWS = Module["_TA_CDLUPSIDEGAP2CROWS"] =
        Module["asm"]["TA_CDLUPSIDEGAP2CROWS"]).apply(null, arguments);
    });
    var _TA_CDLXSIDEGAP3METHODS = (Module[
      "_TA_CDLXSIDEGAP3METHODS"
    ] = function () {
    ...
    var _TA_LINEARREG_INTERCEPT = (Module[
      "_TA_LINEARREG_INTERCEPT"
    ] = function () {
    ...
    var ___assign_got_enties = (Module["___assign_got_enties"] = function () {
      return (___assign_got_enties = Module["___assign_got_enties"] =
        Module["asm"]["__assign_got_enties"]).apply(null, arguments);
    });
    var _TA_Globals = (Module["_TA_Globals"] = 1448);
    var ___data_end = (Module["___data_end"] = 4888);
    for (var name in ["TA_Globals", "__data_end"]) {
      (function (name) {
        Module["g$" + name] = function () {
          return Module[name];
        };
      })(name);
    }

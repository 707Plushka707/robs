 ...
 */
function percentB() {
    return this.deflate(function (band) { return (band.value - band.lower) / (band.upper - band.lower); });
}
;
data_forge_1.DataFrame.prototype.percentB = percentB;
//# sourceMappingURL=bollinger-percent-b.js.map